...
//code to encrypt the payment data being submitted to sagepay
    protected function encryptAndEncode($strIn) {
        ...
        return "@".bin2hex(mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $this->getEncryptPassword(), $strIn, MCRYPT_MODE_CBC, $this->getEncryptPassword()));
    }
...
//code to decrypt the response string SagePay attaches to the failure or success URL
    protected function decodeAndDecrypt($strIn) {
        ...
        $strIn = pack('H*', $strIn);
        return mcrypt_decrypt(MCRYPT_RIJNDAEL_128, $this->getEncryptPassword(), $strIn, MCRYPT_MODE_CBC, $this->getEncryptPassword());
    }
